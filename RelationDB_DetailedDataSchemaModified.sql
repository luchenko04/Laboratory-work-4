...
CREATE TABLE Users (
    USER_ID NUMBER PRIMARY KEY,  -- Заглавные буквы
    USER_NAME VARCHAR(100) NOT NULL,  -- Заглавные буквы
    Email VARCHAR(100) NOT NULL, -- Email без ограничения
    Password VARCHAR(255) NOT NULL  -- Без CHECK на пароль
);
